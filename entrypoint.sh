...
# 2. Copy the repo and assign ownership
cp -a /workspace/readonly_repo /workspace/active_repo

# NEW: Delete any host-machine caches that accidentally got copied over
...
# NEW: Create a valid runtime directory for devenv/postgres
